...
public class PostActivity extends AppCompatActivity {
    ...
    private DatabaseReference UsersRef, PostsRef, LevelRef;
    private FirebaseAuth mAuth;

    private String saveCurrentDate, saveCurrentTime, postRandomName, downloadUrl,cureent_user_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LevelRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                String myLvl=dataSnapshot.child("level").getValue().toString();
    ...
    private void SavingPostInformationToDatabase() {
        ...
        UsersRef.child(cureent_user_id).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    HashMap postsMap=new HashMap();
                        postsMap.put("uid",cureent_user_id);
                    ...
                    PostsRef.child(cureent_user_id+postRandomName).updateChildren(postsMap)
                            .addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    if(task.isSuccessful()){
                                        ...
                                        Toast.makeText(PostActivity.this, "Error Occured while posting...", Toast.LENGTH_SHORT).show();
                                        loadingBar.dismiss();
                                    }
                                }
                            });
